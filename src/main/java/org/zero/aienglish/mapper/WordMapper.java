...
public interface WordMapper {
    ...
    @Mapping(target = "speechPart", source = "vocabulary.speechPart")
    WordResponseDTO map(VocabularySentenceEntity vocabulary);


    @Mapping(target = "speechPart", expression = "java(new org.zero.aienglish.entity.SpeechPartEntity(null, voc.getSpeechPart(), voc.getSpeechPartTranslate(), voc.getAnswersTo()))")
